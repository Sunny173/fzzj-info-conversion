...
public class NewRegexFile {
	static List<Regex> regexs = new ArrayList<Regex>();

	public static RegexString regex() {
		RegexString regex33 = new RegexString();
		Regex regex22 = new Regex();
		regex22.regexName = "1,（2015-3-20第七版）";
		...
		regex22.regexFields = fields;
		regex33.regex_data.add(regex22);

		regex22 = new Regex();
		regex22.regexName = "2, (2015-09-12第9版)";
		...
		regex22 = new Regex();
		regex22.regexName = "3, (2015-08-28第9版)";
		fields = new ArrayList<FieldPosition>();
		fields.add(new FieldPosition("姓　　名", 0, 4, FieldPosition.NMAE));
		fields.add(new FieldPosition("学　　历", 0, 7, FieldPosition.education));
		fields.add(new FieldPosition("职　　业", 0, 8, FieldPosition.occupation));
		...
		regex22 = new Regex();
		regex22.regexName = "4, (2015-09-12第9版)多常住日期";
		fields = new ArrayList<FieldPosition>();
		fields.add(new FieldPosition("姓　　名", 0, 4, FieldPosition.NMAE));
		fields.add(new FieldPosition("学　　历", 0, 7, FieldPosition.education));
		fields.add(new FieldPosition("职　　业", 0, 8, FieldPosition.occupation));
		...
		regex22 = new Regex();
		regex22.regexName = "5,(2016-07-18 201607版)";
		fields = new ArrayList<FieldPosition>();
		fields.add(new FieldPosition("姓　　名", 0, 4, FieldPosition.NMAE));
